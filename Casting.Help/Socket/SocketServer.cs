...
namespace Casting.Help
{
    public class SocketServer
    {
        ...
        public  void SocketConnection(string Ip, int Port)
        {
        ...
        //对指定客户端发送
        public void ClientSendMsg(string ClientId,string sendMsg)
        {
            //将输入的内容字符串转换为机器可以识别的字节数组     
            byte[] arrClientSendMsg = Encoding.UTF8.GetBytes(sendMsg);
            //调用客户端套接字发送字节数组 
            clientConnectionItems[ClientId].Send(arrClientSendMsg);
        }
